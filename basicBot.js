...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/contre-ed/basicBot/contre-ed-patch-2/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/contre-ed/basicBot/contre-ed-patch-2/basicBot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://rawgit.com/ccontre-ed/basicBot/contre-ed-patch-2/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            botName: "basicBot",
            language: "english",
            chatLink: "https://rawgit.com/contre-ed/basicBot/contre-ed-patch-2/lang/en.json",
            startupCap: 1, // 1-200
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/contre-ed/basicBot-customization/master/blacklists/ExampleNSFWlist.json",
                OP: "https://rawgit.com/contre-ed/basicBot-customization/master/blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
            ...
            zujoCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.yooo)
                    }
                }
            },
            ...
            andrewCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.number)
                    }
                }
            },
